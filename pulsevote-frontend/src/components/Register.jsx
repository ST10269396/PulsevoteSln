            ...
            <div className="relative">
              <input
                ...
                className={`input input-bordered w-full pr-10 ${
                  validationErrors.email ? 'input-error' : 'focus:input-primary'
                }`}
                autoComplete="email"
          ...
          <div className="form-control">
            ...
            <div className="relative">
              <input
                ...
                className={`input input-bordered w-full pr-10 ${
                  validationErrors.password ? 'input-error' : 'focus:input-primary'
                }`}
              ...
              <button
                type="button"
                className="absolute inset-y-0 right-0 flex items-center pr-3 hover:bg-base-200 rounded-md p-1 transition-colors"
                onClick={togglePasswordVisibility}
                aria-label={showPassword ? 'Hide password' : 'Show password'}
              >
                {showPassword ? (
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-base-content/60 hover:text-base-content/80 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="form-control">
            ...
            <div className="relative">
              <input
                ...
                className={`input input-bordered w-full pr-10 ${
                  validationErrors.confirmPassword ? 'input-error' : 'focus:input-primary'
            ...
            {validationErrors.confirmPassword && (
              <label className="label">
                <span id="confirm-password-error" className="label-text-alt text-error">
                  {validationErrors.confirmPassword}
                </span>
              </label>
            )}
            ...
            <label className="label cursor-pointer justify-start gap-3">
              <input
                ...
                className={`checkbox checkbox-primary checkbox-sm ${
                  validationErrors.acceptTerms ? 'checkbox-error' : ''
                }`}
              />
